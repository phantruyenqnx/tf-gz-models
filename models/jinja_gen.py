...
if __name__ == "__main__":
    ...
    # Always output to model.sdf in the same directory as the template
    template_dir = os.path.dirname(os.path.abspath(args.filename))
    filename_out = os.path.join(template_dir, 'model.sdf')
